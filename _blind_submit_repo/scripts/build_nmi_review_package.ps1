...
$dataFiles = @(
    ...
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\summary.json",
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\framework_progress.json",
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\framework_heartbeat.jsonl",
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\report.md",
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\ablations.csv",
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\selection.csv",
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\sensitivity.csv",
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\framework_base_metrics_recovery.json",
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\framework_base_metrics_collected.json",
    "data\joint_weather_network_q1_2025outputs\framework_joint_run\collect_framework_base_metrics_progress.jsonl"
)
